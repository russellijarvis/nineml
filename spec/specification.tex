...
\IndexSendPort{}s are used to return indices generated within \ComponentClass\withelem{}\Function elements, which can be used in \MultiCompartmental models to generate branch structures and domain-to-compartment mappings.
