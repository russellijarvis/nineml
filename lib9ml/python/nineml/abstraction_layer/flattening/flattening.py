...
class TransitionResolver(object):
    ...
    def __init__(self, oldtransition, regime_tuple,
        ...
        portconnections = [model.portconnections
                           for model in flattener.all_components]
        ...
        self.unresolved_transitions = [(oldtransition,
                                        transition_regime_tuple_index)]
                ...
                for cascade_regime_index, regime in enumerate(self.dst_regime_tuple):
                    for cascade_ev in regime.on_events:
                        if cascade_ev.src_port_name == recv_port:
                            # print '     (**Cascade found**)'
                            self.unresolved_transitions.append((cascade_ev,
                                                                cascade_regime_index))
